        ...
        <div class="sidebar-list">
            ...
            <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                ...
                @if (auth()->user()->role == 'personel')
                    <li class="nav-item">
                        <a class="nav-link {{ Request::is('personel') ? 'active' : '' }}"
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ Request::is('personel/profile') ? 'active' : '' }}"
                            href="{{ route('personel.profile.index') }}">
                            <i class="icon">
                                <svg width="20" viewBox="0 0 24 24" fill="none"
                                    xmlns="http://www.w3.org/2000/svg" class="icon-20">
                                    <path opacity="0.4"
                ...
                @if (auth()->user()->role == 'kadis')
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="collapse" href="#horizontal-menu" role="button"
                            ...
                            <span class="item-name">Rekap Kinerja</span>
                            <i class="right-icon">
