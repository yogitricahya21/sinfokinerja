@extends('layouts.admin') {{-- Bilang ke Laravel: "Gunakan bingkai ArchitectUI" --}}
...
@section('content')
    <div class="iq-navbar-header" style="height: 215px;">
                        ...
                        <div class="col-md-12">
                            <div class="flex-wrap d-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <p>Selamat datang di sistem manajemen kinerja {{ ucfirst(auth()->user()->role) }}.</p>
                                </div>
                                <div>
                ...
                <div class="iq-header-img">
                    ...
                    <img src="{{ asset('template/') }}/assets/images/dashboard/top-header1.png" alt="header"
                        class="theme-color-purple-img img-fluid w-100 h-100 animated-scaleX">
                    <img src="{{ asset('template/') }}/assets/images/dashboard/top-header2.png" alt="header"
                        class="theme-color-blue-img img-fluid w-100 h-100 animated-scaleX">
                    <img src="{{ asset('template/') }}/assets/images/dashboard/top-header3.png" alt="header"
                        class="theme-color-green-img img-fluid w-100 h-100 animated-scaleX">
                    <img src="{{ asset('template/') }}/assets/images/dashboard/top-header4.png" alt="header"
                        class="theme-color-yellow-img img-fluid w-100 h-100 animated-scaleX">
                    <img src="{{ asset('template/') }}/assets/images/dashboard/top-header5.png" alt="header"
